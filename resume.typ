...
= Summary
Senior Systems & Cyber Security Engineer with 30+ years leading infrastructure automation, vulnerability management, and secure Linux environments in finance and government. Recognized Ansible/Python expert, open-source contributor, and automation and documentation as code evangelist.
...
- *Protocols & Services*: DNS, LDAP, SSH, GEMINI, HTTP, HTTPS, SMTP, POP, IMAP, etc.
...
- Reimplemented Maxthink PERM Decision Tree Builder in Python
...
- Developed enterprise-wide Ansible playbooks and roles as recognized subject-matter expert, automating security-agent deployments
...
- “pyPERM-DecisionTree Decision Tree Builder,” Open-Source Project (Apr 2025)
